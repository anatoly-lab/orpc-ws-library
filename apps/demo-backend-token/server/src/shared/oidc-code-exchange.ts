// Server-side OIDC Authorization-Code + PKCE flow for this token-holding
// backend demo app. The SERVER is the OAuth client here: it
 ...
 * adding a `jose` dependency to this app's server for a display-only concern.
 */
